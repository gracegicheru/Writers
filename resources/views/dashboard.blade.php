...
<div id="main-wrapper">
                ...
                <ul id="sidebarnav">
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                        <ul aria-expanded="false" class="collapse">
                            ...
                            <li><a href="index2.html">In Progress</a></li>
                            <li><a href="index3.html">Delivered</a></li>
                            <li><a href="index4.html">Payments</a></li>
                        </ul>
                    </li>
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-menu"></i><span class="hide-menu">Orders</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="app-calendar.html">Pending</a></li>
                            <li><a href="app-chat.html">In Progress</a></li>
                            <li><a href="app-ticket.html">Delivered</a></li>
                            <li><a href="app-contact.html">All Orders</a></li>
                        </ul>
                    </li>
                    <li class="three-column"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-message-text-outline"></i><span class="hide-menu">Messages</span></a>
                    </li>
                    <li class="two-column"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-cash"></i><span class="hide-menu">Payments</span></a>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h3 class="pending"></h3>
                                <h6 class="card-subtitle">Pending</h6></div>
                            <div class="col-12">
                                <div class="progress">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h6 class="card-subtitle">All Orders</h6></div>
                            <div class="col-12">
                                <div class="progress">
        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <footer class="footer">Pro.writenod.com {{date('d-m-Y')}}</footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    </div>
